var mouse,mouseCheese,mouseD,mouseCollide;
var cat,catSit;catWalk,catCollide;
var bg,bgImg;

function preload() {
  mouseCheese = loadImage("mouse1.png");
  mouseD = loadAnimation("mouse2.png","mouse3.png");
...
function setup(){
 ...
 mouse.addAnimation("mouse2,mouse3",mouseD);
mouse.scale = 0.1;
...
if(keyDown(LEFT_ARROW)) {
 ...
 mouse.changeAnimation("mouse2,mouse3",mouseD);
  }
}
